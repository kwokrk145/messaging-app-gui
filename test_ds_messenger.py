import unittest
import ds_messenger
class Testing_ds_messenger(unittest.TestCase):
    ...
    def test_retrieve_new(self):
        server = "168.235.86.101"
        x = ds_messenger.DirectMessenger("168.235.86.101", "codewars1209", "hi")
        x.send("this assignment","codewars12")
        x2 = ds_messenger.DirectMessenger("168.235.86.101", "codewars12", "hi")
